...
/*
* Класс, в котором хранятся все объекты состояний игры
* Этот класс описывает взаимодействие между ними, а так же в каком из состояний сейчас находится игра.
*  Какое состояние обновлять и отрисовывать.
* */
